(function(A) {
    A.extend(A.fn, {pstrength: function(B) {
            var B = A.extend({verdects: ["Sehr schwach", "Schwach", "Mittel", "Stark", "Sehr stark"],colors: ["#f00", "#c06", "#f60", "#3c0", "#3f0"],scores: [10, 15, 30, 40],common: ["password", "sex", "god", "123456", "123", "liverpool", "letmein", "qwerty", "monkey"],minchar: 6}, B);
            return this.each(function() {
                var C = A(this).attr("id");
                A(this).after("<div class=\"pstrength-minchar\" id=\"" + C + "_minchar\">Mindestens " + B.minchar + " Zeichen.</div>");
